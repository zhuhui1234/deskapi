<?php
    ...
    class Page {
        ...
        public function __construct($total, $listRows=25, $pa="", $ord=true){
            ...
            $this->pageNum= $total;//ceil($this->total/$this->listRows);
            if(!empty($_GET["page"])) {
                $page=$_GET["page"];
            }else{
                if($ord)
        ...
        private function firstprev(){
            if($this->page > 1) {
                ...
                $str="<li class='disabled'><a>{$this->config["first"]}</a></li>";
        ...
        private function pageList(){
            ...
            if($this->page == $this->pageNum || $this->pageNum <= $page || $this->pageNum == 4){
                $linkPage.='';
            }else{
                $linkPage.="<li class='disabled'><a>...</a></li>";
                $linkPage.="<li><a href='{$this->uri}page=".($this->pageNum)."'>{$this->total}</a></li>";
            }
            $linkPage.='';
            return $linkPage;
        }
        ...
        private function nextlast(){
            if($this->page != $this->pageNum) {
                ...
                $str.="<li class='disabled'><a>{$this->config["last"]}</a></li>";
            }
